...
### Changed
- Upgraded API version from v1 to v2
- Added timeout parameter to getBaseURL() function
- Added timeout validation with configurable limits (DEFAULT_TIMEOUT, MAX_TIMEOUT)
- Added validateTimeout() function
